...
function tonicIntervalsTransposer(intervals2, tonic) {
  ...
  return (normalized) => {
    ...
    return transpose(root, intervals2[index5]);
  };
}
...
// node_modules/.pnpm/@tonaljs+abc-notation@4.9.1/node_modules/@tonaljs/abc-notation/dist/index.mjs
...
function transpose2(note22, interval3) {
  return scientificToAbcNotation(transpose(abcToScientificNotation(note22), interval3));
}
...
// node_modules/.pnpm/@tonaljs+array@4.8.4/node_modules/@tonaljs/array/dist/index.mjs
var dist_exports = {};
...
function listToChroma(set) {
  ...
  for (let i = 0; i < set.length; i++) {
    pitch3 = note(set[i]);
    if (pitch3.empty) pitch3 = interval(set[i]);
    if (!pitch3.empty) binary[pitch3.chroma] = 1;
  }
  return binary.join("");
}
var EmptyPcset, setNumToChroma, chromaToNumber, REGEX4, isPcsetNum, isPcset, cache3, pcset, chroma, intervals, num, IVLS, pcset_default;
var init_dist8 = __esm({
  "node_modules/.pnpm/@tonaljs+pcset@4.10.1/node_modules/@tonaljs/pcset/dist/index.mjs"() {
    ...
    cache3 = { [EmptyPcset.chroma]: EmptyPcset };
    pcset = get;
...
function getQuality(intervals2) {
  const has = (interval3) => intervals2.indexOf(interval3) !== -1;
...
// node_modules/.pnpm/@tonaljs+pitch@5.0.1/node_modules/@tonaljs/pitch/dist/index.mjs
...
var SIZES2, chroma2, height, midi, FIFTHS2, STEPS_TO_OCTS2, FIFTHS_TO_STEPS2;
var init_dist11 = __esm({
  "node_modules/.pnpm/@tonaljs+pitch@5.0.1/node_modules/@tonaljs/pitch/dist/index.mjs"() {
    SIZES2 = [0, 2, 4, 5, 7, 9, 11];
    chroma2 = ({ step, alt }) => (SIZES2[step] + alt + 120) % 12;
    height = ({ step, alt, oct, dir = 1 }) => dir * (SIZES2[step] + alt + 12 * (oct === void 0 ? -100 : oct));
    midi = (pitch22) => {
...
// node_modules/.pnpm/@tonaljs+pitch-interval@5.0.2/node_modules/@tonaljs/pitch-interval/dist/index.mjs
...
function interval2(src) {
  return typeof src === "string" ? cache4[src] || (cache4[src] = parse3(src)) : isPitch2(src) ? interval2(pitchName3(src)) : isNamedPitch2(src) ? interval2(src.name) : NoInterval2;
}
function parse3(str) {
  ...
  const chroma5 = (dir * (SIZES3[step] + alt) % 12 + 12) % 12;
...
var fillStr4, NoInterval2, INTERVAL_TONAL_REGEX2, INTERVAL_SHORTHAND_REGEX2, REGEX5, cache4, SIZES3, TYPES2;
var init_dist12 = __esm({
  "node_modules/.pnpm/@tonaljs+pitch-interval@5.0.2/node_modules/@tonaljs/pitch-interval/dist/index.mjs"() {
    init_dist11();
    fillStr4 = (s, n) => Array(Math.abs(n) + 1).join(s);
    NoInterval2 = { empty: true, name: "", acc: "" };
...
// node_modules/.pnpm/@tonaljs+pitch-note@5.0.3/node_modules/@tonaljs/pitch-note/dist/index.mjs
function note2(src) {
  const stringSrc = JSON.stringify(src);
  ...
  const value2 = typeof src === "string" ? parse4(src) : isPitch2(src) ? note2(pitchName4(src)) : isNamedPitch2(src) ? note2(src.name) : NoNote2;
  cache5.set(stringSrc, value2);
  return value2;
}
...
var fillStr5, NoNote2, cache5, stepToLetter2, altToAcc2, accToAlt2, REGEX6, mod2, SEMI2;
var init_dist13 = __esm({
  "node_modules/.pnpm/@tonaljs+pitch-note@5.0.3/node_modules/@tonaljs/pitch-note/dist/index.mjs"() {
    ...
    altToAcc2 = (alt) => alt < 0 ? fillStr5("b", -alt) : fillStr5("#", alt);
    accToAlt2 = (acc) => acc[0] === "b" ? -acc.length : acc.length;
    REGEX6 = /^([a-gA-G]?)(#{1,}|b{1,}|x{1,}|)(-?\d*)\s*(.*)$/;
    mod2 = (n, m) => (n % m + m) % m;
    SEMI2 = [0, 2, 4, 5, 7, 9, 11];
  }
});

// node_modules/.pnpm/@tonaljs+pitch-distance@5.0.2/node_modules/@tonaljs/pitch-distance/dist/index.mjs
...
function tonicIntervalsTransposer2(intervals2, tonic) {
  ...
  return (normalized) => {
    ...
    return transpose3(root, intervals2[index5]);
  };
}
...
// node_modules/.pnpm/@tonaljs+core@4.10.4/node_modules/@tonaljs/core/dist/index.mjs
var dist_exports2 = {};
__export(dist_exports2, {
  ...
  interval: () => interval2,
  isNamed: () => isNamed,
  isNamedPitch: () => isNamedPitch2,
  isPitch: () => isPitch2,
  midi: () => midi,
  note: () => note2,
  pitch: () => pitch2,
  stepToLetter: () => stepToLetter2,
  tokenizeInterval: () => tokenizeInterval2,
...
var init_dist15 = __esm({
  "node_modules/.pnpm/@tonaljs+core@4.10.4/node_modules/@tonaljs/core/dist/index.mjs"() {
    ...
    isNamed = deprecate("isNamed", "isNamedPitch", isNamedPitch2);
  }
});

// node_modules/.pnpm/@tonaljs+chord-type@4.8.2/node_modules/@tonaljs/chord-type/dist/index.mjs
function get2(type) {
...
// node_modules/.pnpm/@tonaljs+scale-type@4.9.1/node_modules/@tonaljs/scale-type/dist/index.mjs
function names2() {
...
// node_modules/.pnpm/@tonaljs+chord@4.10.2/node_modules/@tonaljs/chord/dist/index.mjs
...
function transpose4(chordName, interval3) {
  const [tonic, type] = tokenize2(chordName);
  if (!tonic) {
    return chordName;
  }
  return transpose3(tonic, interval3) + type;
}
...
function get5(name3) {
  const [_, simple, dots] = REGEX7.exec(name3) || [];
...
var DATA, data_default4, VALUES, NoDuration, REGEX7, value, fraction, duration_value_default;
...
// node_modules/.pnpm/@tonaljs+interval@4.8.2/node_modules/@tonaljs/interval/dist/index.mjs
function names4() {
  return "1P 2M 3M 4P 5P 6m 7m".split(" ");
}
function simplify(name22) {
  const i = interval2(name22);
...
function invert(name22) {
  ...
  return interval2({ step, alt, oct: i.oct, dir: i.dir }).name;
}
...
function transposeFifths(interval3, fifths) {
  const ivl = get6(interval3);
  if (ivl.empty)
    return "";
...
var init_dist20 = __esm({
  "node_modules/.pnpm/@tonaljs+interval@4.8.2/node_modules/@tonaljs/interval/dist/index.mjs"() {
    ...
    init_dist12();
    get6 = interval2;
    name = (name22) => interval2(name22).name;
    semitones = (name22) => interval2(name22).semitones;
    quality = (name22) => interval2(name22).q;
    num2 = (name22) => interval2(name22).num;
    IN = [1, 2, 2, 3, 3, 4, 5, 5, 6, 6, 7, 7];
    IQ = "P m M m M P d P m M m M".split(" ");
    distance4 = distance;
    add5 = combinator((a, b) => [a[0] + b[0], a[1] + b[1]]);
    addTo = (interval3) => (other) => add5(interval3, other);
...
function pcsetFromChroma(chroma22) {
  return chroma22.split("").reduce((pcset22, val, index5) => {
    if (index5 < 12 && val === "1") pcset22.push(index5);
    return pcset22;
  }, []);
}
...
function pcsetSteps(notes3, tonic) {
  ...
  return (step) => {
    const index5 = step < 0 ? (len - -step % len) % len : step % len;
    const octaves = Math.floor(step / len);
    return set[index5] + octaves * 12 + tonic;
  };
}
...
var init_dist22 = __esm({
  "node_modules/.pnpm/@tonaljs+note@4.12.1/node_modules/@tonaljs/note/dist/index.mjs"() {
    ...
    tr = transpose;
    transposeBy = (interval3) => (note3) => transpose5(note3, interval3);
    trBy = transposeBy;
    transposeFrom = (note3) => (interval3) => transpose5(note3, interval3);
...
function get8(src) {
  return typeof src === "string" ? cache6[src] || (cache6[src] = parse5(src)) : typeof src === "number" ? get8(NAMES2[src] || "") : isPitch(src) ? fromPitch(src) : isNamedPitch(src) ? get8(src.name) : NoRomanNumeral;
}
function names6(major = true) {
  return (major ? NAMES2 : NAMES_MINOR).slice();
}
function fromPitch(pitch3) {
  return get8(altToAcc(pitch3.alt) + NAMES2[pitch3.step]);
}
...
var NoRomanNumeral, cache6, romanNumeral, REGEX8, ROMANS, NAMES2, NAMES_MINOR, roman_numeral_default;
var init_dist23 = __esm({
  "node_modules/.pnpm/@tonaljs+roman-numeral@4.9.1/node_modules/@tonaljs/roman-numeral/dist/index.mjs"() {
    ...
    cache6 = {};
    romanNumeral = get8;
    REGEX8 = /^(#{1,}|b{1,}|x{1,}|)(IV|I{1,3}|VI{0,2}|iv|i{1,3}|vi{0,2})([^IViv]*)$/;
...
function keyScale(grades, triads2, chordTypes, harmonicFunctions, chordScales2) {
  return (tonic) => {
    ...
    const scale2 = intervals2.map((interval3) => transpose5(tonic, interval3));
...
var init_dist24 = __esm({
  "node_modules/.pnpm/@tonaljs+key@4.11.2/node_modules/@tonaljs/key/dist/index.mjs"() {
    ...
    supertonics = (dominants, targetTriads) => {
      return dominants.map((chord2, index5) => {
        if (!chord2) return "";
        const domRoot = chord2.slice(0, -1);
        const minorRoot = transpose5(domRoot, "5P");
        const target = targetTriads[index5];
...
function transposeFifths3(interval3, fifths) {
  const ivl = get9(interval3);
  if (ivl.empty) return "";
  const [nFifths, nOcts, dir] = ivl.coord;
...
// node_modules/.pnpm/@tonaljs+mode@4.9.1/node_modules/@tonaljs/mode/dist/index.mjs
...
var init_dist26 = __esm({
  "node_modules/.pnpm/@tonaljs+mode@4.9.1/node_modules/@tonaljs/mode/dist/index.mjs"() {
    ...
    mode = get10;
    entries3 = all4;
    triads = chords(MODES.map((x) => x[4]));
    seventhChords = chords(MODES.map((x) => x[5]));
    mode_default = {
      get: get10,
      names: names7,
      all: all4,
...
// node_modules/.pnpm/@tonaljs+chord@6.1.1/node_modules/@tonaljs/chord/dist/index.mjs
...
// node_modules/.pnpm/@tonaljs+progression@4.9.1/node_modules/@tonaljs/progression/dist/index.mjs
...
// node_modules/.pnpm/@tonaljs+range@4.9.2/node_modules/@tonaljs/range/dist/index.mjs
...
// node_modules/.pnpm/@tonaljs+scale@4.13.3/node_modules/@tonaljs/scale/dist/index.mjs
...
// node_modules/.pnpm/@tonaljs+time-signature@4.9.0/node_modules/@tonaljs/time-signature/dist/index.mjs
function names9() {
  return NAMES3.slice();
}
function get13(literal) {
  ...
  const ts = build(parse6(literal));
  CACHE.set(stringifiedLiteral, ts);
  return ts;
}
function parse6(literal) {
  if (typeof literal === "string") {
    const [_, up2, low] = REGEX9.exec(literal) || [];
    return parse6([up2, low]);
  }
...
var NONE, NAMES3, REGEX9, CACHE, time_signature_default, isPowerOfTwo;
var init_dist31 = __esm({
  "node_modules/.pnpm/@tonaljs+time-signature@4.9.0/node_modules/@tonaljs/time-signature/dist/index.mjs"() {
    ...
    time_signature_default = { names: names9, parse: parse6, get: get13 };
    isPowerOfTwo = (x) => Math.log(x) / Math.log(2) % 1 === 0;
  }
});

// node_modules/.pnpm/@tonaljs+tonal@4.10.0/node_modules/@tonaljs/tonal/dist/index.mjs
var dist_exports3 = {};
...
var require_voicingsInRange = __commonJS({
  "node_modules/.pnpm/chord-voicings@0.0.1/node_modules/chord-voicings/dist/voicingsInRange.js"(exports) {
    ...
    var tonal_1 = (init_dist32(), __toCommonJS(dist_exports3));
    var dictionaryVoicing_1 = require_dictionaryVoicing();
    var tokenizeChord_1 = require_tokenizeChord();
    function voicingsInRange(chord2, dictionary4, range3) {
      if (dictionary4 === void 0) {
        dictionary4 = dictionaryVoicing_1.lefthand;
      }
      if (range3 === void 0) {
        range3 = ["D3", "A4"];
      }
      var _a = (0, tokenizeChord_1.tokenizeChord)(chord2), tonic = _a[0], symbol = _a[1];
      if (!dictionary4[symbol]) {
        return [];
      }
      var voicings = dictionary4[symbol].map(function(intervals2) {
        return intervals2.split(" ");
      });
      var notesInRange = tonal_1.Range.chromatic(range3);
      return voicings.reduce(function(voiced, voicing) {
        var relativeIntervals = voicing.map(function(interval3) {
          return tonal_1.Interval.substract(interval3, voicing[0]);
        });
        ...
        var notes3 = starts.map(function(start) {
          return relativeIntervals.map(function(interval3) {
            return tonal_1.Note.transpose(start, interval3);
          });
        });
...
var require_dictionaryVoicing = __commonJS({
  "node_modules/.pnpm/chord-voicings@0.0.1/node_modules/chord-voicings/dist/dictionaryVoicing.js"(exports) {
    ...
    var dictionaryVoicingFinder = function(dictionary4) {
      return function(chordSymbol, range3) {
        return (0, voicingsInRange_1.voicingsInRange)(chordSymbol, dictionary4, range3);
      };
    };
    exports.dictionaryVoicingFinder = dictionaryVoicingFinder;
    var dictionaryVoicing = function(props) {
      var dictionary4 = props.dictionary, range3 = props.range, rest = __rest(props, ["dictionary", "range"]);
      return (0, getBestVoicing_1.getBestVoicing)(__assign(__assign({}, rest), { range: range3, finder: (0, exports.dictionaryVoicingFinder)(dictionary4) }));
    };
...
// node_modules/.pnpm/@strudel+tonal@1.2.5/node_modules/@strudel/tonal/dist/index.mjs
init_dist32();
...
var T = {};
function s1(m, P, M, t) {
  const [n, e] = index_default5.tokenize(P), d = S(n), o = G(d);
  if (!T[e]) {
    const { intervals: f } = index_default5.get(`C ${e}`);
    T[e] = f.map(K);
  }
  const r = T[e];
  if (!r)
  ...
  if (M) {
    M = S(M, 3);
    const f = G(M), l2 = ft(f - o, 12), A = Q(l2, r, t);
    m = m + A, c = M - l2;
  }
...
function c1({ chord: m, dictionary: P, offset: M = 0, n: t, mode: n = "below", anchor: e = "c5", octaves: d = 1 }) {
  ...
  let f, l2, A = i.map((a, D) => {
    const m1 = H[n](a), E2 = ft(s - m1 - c, 12);
    return (f === void 0 || E2 < f) && (f = E2, l2 = D), E2;
  });
  n === "root" && (l2 = 0);
  const N = Math.ceil(M / i.length) * 12, x = ft(l2 + M, i.length), $ = i[x], Y = H[n]($), Z = e - A[x] + N, B2 = $.map((a) => Z - Y + a);
  let C = B2.map((a) => d1(a));
  return n === "duck" && (C = C.filter((a, D) => B2[D] !== e)), t !== void 0 ? [r1(C, t, d)] : C;
}
var i1 = (m) => {
  var _a;
  if (typeof m != "string")
    return [];
  const [P, M = "", t] = ((_a = m.match(/^([a-gA-G])([#bsf]*)(-?[0-9]*)$/)) == null ? void 0 : _a.slice(1)) || [];
...
var L = (m, P = 3) => {
  ...
  const e = a1[M.toLowerCase()], d = (t == null ? void 0 : t.split("").reduce((o, r) => o + f1[r], 0)) || 0;
  return (Number(n) + 1) * 12 + e + d;
};
var u1 = (m) => (m <= 0 ? -1 : 1) + m * 7 + "P";
function z2(m) {
  m = m.replaceAll(":", " ");
  const P = index_default5.get(m), { tonic: M, empty: t } = P;
  if (t && qt(m) || t && !M)
    throw new Error(
...
function l1(m, P) {
  m = Math.ceil(m);
  let { intervals: M, tonic: t } = z2(P);
  t = t || "C";
  const { pc: n, oct: e = 3 } = index_default2.get(t), d = Math.floor(m / M.length), o = ft(m, M.length), r = interval_default.add(M[o], u1(d));
  return index_default2.transpose(n + e, r);
}
function O(m, P, M) {
  let { notes: t } = z2(m);
  if (t = t.map((i) => index_default2.get(i).pc), P = Number(P), isNaN(P))
    throw new Error(`scale offset "${P}" not a number`);
  const { pc: n, oct: e = 3 } = index_default2.get(M), d = t.indexOf(n);
  if (d === -1)
  ...
  for (; Math.abs(o - d) < Math.abs(P); ) {
    o += s;
    const i = ft(o, t.length);
    s < 0 && c[0] === "C" && (r += s), c = t[i], s > 0 && c[0] === "C" && (r += s);
  }
  return c + r;
}
var { transpose: E1, trans: I1 } = l(["transpose", "trans"], function(P, M) {
  return M.withHap((t) => {
    ...
    const e = isNaN(Number(P)) ? String(P) : interval_default.fromSemitones(P), d = index_default2.transpose(n, e);
...
var k = {};
function g1(m, P, M = true) {
  let t = typeof P == "string" ? L(P) : P;
  if (k[m] === void 0) {
    const { intervals: i, tonic: f } = z2(m), { pc: l2 } = index_default2.get(f), N = i.concat("8P").map(($) => index_default2.transpose(l2 + "0", $)), x = N.map(L);
    k[m] = [x, N];
  }
    ...
    return Array.isArray(m) && (m = m.flat().join(" ")), P.fmap((M) => {
      ...
      if (!t || t && ("n" in M || "value" in M)) {
        ...
        try {
          const [e, d] = b1(n);
          let o;
          t && M.anchor ? o = s1(e, m, M.anchor) : o = l1(e, m), d != 0 && (o = index_default2.transpose(o, interval_default.fromSemitones(d))), M = z(t ? { ...M, note: o } : o);
        } catch (e) {
...
var U = "ireal";
var x1 = (m) => U = m;
var S1 = (m, P) => $1(m, y[m].dictionary, P);
var $1 = (m, P, M = ["F3", "A4"]) => {
...
var V;
var F1 = l("voicings", function(m, P) {
  return P.fmap((M) => (V = C1(M, m, V), B(...V))).outerJoin();
});
var _1 = l("rootNotes", function(m, P) {
  return P.fmap((M) => {
...
export {
  index_default5 as index_default,
  init_dist32 as init_dist,
  E1,
  I1,
  T1,
  k1,
...
//# sourceMappingURL=chunk-ZVEGFOQW.js.map
