...
// node_modules/.pnpm/superdough@1.2.6/node_modules/superdough/dist/index.mjs
...
var fe = (t) => console.log(t);
function fn(t, e = "superdough") {
  console.error(t), N(`[${e}] error: ${t.message}`);
}
var N = (...t) => fe(...t);
var Fo = (t) => {
  fe = t;
...
var xn = { c: 0, d: 2, e: 4, f: 5, g: 7, a: 9, b: 11 };
var gn = { "#": 1, b: -1, s: 1, f: -1 };
var zt = (t, e = 3) => {
  const [n, o, s = e] = Mn(t);
  if (!n)
    throw new Error('not a note: "' + t + '"');
  const c = xn[n.toLowerCase()], a = (o == null ? void 0 : o.split("").reduce((d, l) => d + gn[l], 0)) || 0;
  return (Number(s) + 1) * 12 + c + a;
};
var Me = (t) => Math.pow(2, (t - 69) / 12) * 440;
var D = (t, e, n) => Math.min(Math.max(t, e), n);
var Ln = (t) => 12 * Math.log(t / 440) / Math.LN2 + 69;
var Kn = (t, e) => {
  if (typeof t != "object")
...
var xe = (t, e) => (t % e + e) % e;
var he = (t, e) => xe(Math.round(O(t, 0)), e);
function zn(t, e) {
  return t / e;
}
function ge(t, e) {
...
function Jt(t = "white", e, n = 0.02) {
  ...
  return s.buffer = Le(t, n), s.loop = true, s.start(e), {
    node: s,
    stop: (c) => s.stop(c)
  };
}
...
var Ke = ["pink", "white", "brown", "crackle"];
function C(t) {
...
var k = (t, e, n, o, s, c, a, d, l, i = "exponential") => {
...
function be(t, e, n, o, s, c) {
  ...
  return Z == null && (Z = Object.values(V).some((M) => M != null) ? y : 0), Z && (X = Tt(t, n, o, {
    ...
    dcoffset: W,
    ...V
  }), X.connect(e)), { lfo: X, disconnect: () => X == null ? void 0 : X.disconnect() };
}
...
var Cn = (t, e = 1, n = "sine") => {
  const o = x();
  let s;
  Ke.includes(n) ? (s = o.createBufferSource(), s.buffer = Le(n, 2), s.loop = true) : (s = o.createOscillator(), s.type = n, s.frequency.value = t), s.start();
...
var ze = (t) => t / (1 + t);
var In = (t, e) => (t % e + e) % e;
var Pn = (t, e) => (1 + e) * t / (1 + e * Math.abs(t));
var nt = (t, e) => Math.tanh(t * (1 + e));
var kn = (t, e) => D((1 + e) * t, -1, 1);
var Te = (t, e) => {
  let n = (1 + 0.5 * e) * t;
  const o = In(n + 1, 4);
  return 1 - Math.abs(o - 2);
};
var Qn = (t, e) => Math.sin(Math.PI / 2 * Te(t, e));
var Jn = (t, e) => {
...
var dt = Object.freeze(Object.keys(Se));
var Ho = (t) => {
  let e = t;
...
var Bn = (t, e, n) => I(x(), "distort-processor", { distort: t, postgain: e }, { processorOptions: { algorithm: n } });
var et = (t, e = 36) => {
  let { note: n, freq: o } = t;
...
var Dn = async (t, e, n) => {
  ...
  t.loop && (a.loop = true, a.loopStart = d * a.buffer.duration - u, a.loopEnd = l * a.buffer.duration - u);
...
var qn = (t, e, n = t._base || "") => Object.entries(t).forEach(([o, s]) => {
...
async function eo(t, e, n, o, s) {
  ...
  z.connect(R), Z.onended = function() {
    Z.disconnect(), G == null ? void 0 : G.stop(), z.disconnect(), R.disconnect(), n();
  };
  let J = S + y + 0.01;
  Z.stop(J);
...
var co = class {
  ...
  disconnect() {
    var _a, _b;
    this.output.disconnect(), this.summingNode.disconnect(), (_a = this.delayNode) == null ? void 0 : _a.disconnect(), (_b = this.reverbNode) == null ? void 0 : _b.disconnect();
  }
  getDjf(e, n = 0) {
  ...
  getDelay(e = 0, n = 0.5, o) {
    var _a, _b;
    return n = D(n, 0, 0.98), this.delayNode == null && (this.delayNode = this.audioContext.createFeedbackDelay(1, e, n), this.delayNode.connect(this.summingNode), (_b = (_a = this.delayNode).start) == null ? void 0 : _b.call(_a, o)), this.delayNode.delayTime.value !== e && this.delayNode.delayTime.setValueAtTime(e, o), this.delayNode.feedback.value !== n && this.delayNode.feedback.setValueAtTime(n, o), this.delayNode;
  }
...
var Et = new Map(Object.entries(mt));
function ke(t, e) {
  Et.set(t, e);
}
function T(t) {
...
function $o(t = "time", e = 1) {
  const n = {
    time: () => {
      var _a;
      return (_a = v[e]) == null ? void 0 : _a.getFloatTimeDomainData(ot[e]);
    },
    frequency: () => {
      var _a;
      return (_a = v[e]) == null ? void 0 : _a.getFloatFrequencyData(ot[e]);
    }
  }[t];
  if (!n)
...
var Go = async (t, e, n, o = 0.5, s = 0.5) => {
  ...
  for (let f = 0; f <= lt.size - He; f++) {
    ...
    (_b = (_a = Y == null ? void 0 : Y.node) == null ? void 0 : _a.gain) == null ? void 0 : _b.linearRampToValueAtTime(0, ue), (_c = Y == null ? void 0 : Y.stop) == null ? void 0 : _c.call(Y, ue), lt.delete(xt);
  }
  let Wt = [];
  if (["-", "~", "_"].includes(m))
    return;
  ...
  if (X)
    ...
    const { onTrigger: f } = ut(m), Y = await f(e, t, () => {
      Wt.forEach((xt) => xt == null ? void 0 : xt.disconnect()), lt.delete(re);
    }, o);
...
var Vo = ["triangle", "square", "sawtooth", "sine"];
var Wo = [
  ["tri", "triangle"],
  ["sqr", "square"],
  ["saw", "sawtooth"],
  ...
  [...Vo].forEach((t) => {
    ...
    (t, e, n) => {
      ...
      let L = rt(
        o,
        () => {
          it(Z), M.disconnect(), n(), G == null ? void 0 : G.stop(), V == null ? void 0 : V.stop();
        },
        t,
        b
      );
    ...
    (t, e, n) => {
      ...
      let V = rt(
        o,
        () => {
          it(b), it(W), Z.disconnect(), n(), y == null ? void 0 : y.stop(), X == null ? void 0 : X.stop();
        },
        t,
        m
      );
...
function xo(t, e, n) {
  ...
  let i;
  return c && (i = Sn(a, c, e)), {
    node: (i == null ? void 0 : i.node) || a,
    stop: (r) => {
      l.stop(r), d == null ? void 0 : d.stop(r), i == null ? void 0 : i.stop(r), a.stop(r);
    },
    triggerRelease: (r) => {
    }
  };
...
function go(t = 1, e = 0.05, n = 220, o = 0, s = 0, c = 0.1, a = 0, d = 1, l = 0, i = 0, r = 0, u = 0, p = 0, h = 0, m = 0, b = 0, X = 0, y = 1, Z = 0, W = 0) {
  ...
  for (o = o * G + 9, Z *= G, s *= G, c *= G, X *= G, i *= 500 * V / G ** 3, m *= V / G, r *= V / G, u *= G, p = p * G | 0, U = o + Z + s + c + X | 0; g < U; S[g++] = H)
    ...
    Math.cos(m * J++), R += q - q * h * (1 - (Math.sin(g) + 1) * 1e9 % 2), w && ++w > u && (n += r, z += r, w = 0), p && !(++P % p) && (n = z, l = L, w || (w = 1));
  return S;
}
var Lo = (t, e) => {
  let {
...
typeof window < "u" && window.addEventListener("message", (t) => {
  var _a;
  t.data === "strudel-stop" ? Ue() : ((_a = t.data) == null ? void 0 : _a.dough) && (ct == null ? void 0 : ct.node.port.postMessage(t.data));
});
var oc = async (t) => {
  const e = x();
...
var We = (t, e, n, o = {}) => (e = t._base || e, Object.entries(t).forEach(([s, c]) => {
  if (s === "_base") return false;
  if (typeof c == "string" && (c = [c]), typeof c != "object")
    throw new Error("wrong json format for " + s);
  let a = e;
  a.startsWith("github:") && (a = ve(a, "")), c = c.map((d) => a + d).filter((d) => d.toLowerCase().endsWith(".wav") ? true : (N(`[wavetable] skipping ${d} -- wavetables must be ".wav" format`), false)), c.length && Be(s, c, { baseUrl: e, frameLen: n });
}));
function Be(t, e, n) {
  j(
    t,
...
async function wo(t, e, n, o, s, c) {
  ...
  const bt = { node: _, source: L }, Rt = rt(
    r,
    () => {
      it(L), q == null ? void 0 : q.stop(), U == null ? void 0 : U.stop(), _.disconnect(), P == null ? void 0 : P.disconnect(), H == null ? void 0 : H.disconnect(), n();
    },
    t,
    M
  );
...
//# sourceMappingURL=chunk-27ASFBBY.js.map
